...
@Autonomous(name = "RED_Top_ScoreTHREE")
public class RED_Top_ScoreTHREE extends OpMode {
...
//    public Intake intake;
    ...
    private final Pose StartTOP_Red = new Pose(0, 0, Math.toRadians(90));
    ...
    public void buildPaths(){
        ...
        ScoreFIRST = follower.pathBuilder()
                .addPath(new BezierLine(StartTOP_Red, midPoint_Triangle))
                .setLinearHeadingInterpolation(StartTOP_Red.getHeading(), midPoint_Triangle.getHeading())

                .addPath(new BezierLine(midPoint_Triangle, groupAPickUp1_RED))
                .setLinearHeadingInterpolation(StartTOP_Red.getHeading(), groupAPickUp1_RED.getHeading())
                ...
                .addPath(new BezierLine(groupAPickUp2_RED, midPoint_Triangle))
                .setLinearHeadingInterpolation(groupAPickUp2_RED.getHeading(), midPoint_Triangle.getHeading())

                .build();

        ScoreSECOND = follower.pathBuilder()
                .addPath(new BezierLine(midPoint_Triangle, groupBPickUp1_RED))
                .setLinearHeadingInterpolation(midPoint_Triangle.getHeading(), groupBPickUp1_RED.getHeading())
                ...
                .addPath(new BezierLine(groupBPickUp2_RED, midPoint_Triangle))
                .setLinearHeadingInterpolation(midPoint_Triangle.getHeading(), groupBPickUp2_RED.getHeading())

                .build();

        ScoreTHIRD = follower.pathBuilder()
                .addPath(new BezierLine(midPoint_Triangle, groupCPickUp1_RED))
                .setLinearHeadingInterpolation(midPoint_Triangle.getHeading(), groupCPickUp1_RED.getHeading())

                .addPath(new BezierLine(groupCPickUp1_RED, groupCPickUp2_RED))
                .setLinearHeadingInterpolation(groupBPickUp1_RED.getHeading(), groupBPickUp2_RED.getHeading())

                .addPath(new BezierLine(groupCPickUp2_RED, midPoint_Triangle))
                .setLinearHeadingInterpolation(midPoint_Triangle.getHeading(), groupBPickUp2_RED.getHeading())
