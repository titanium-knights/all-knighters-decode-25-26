...
@Autonomous(name = "BLUE_bT3")
public class BLUE_bT3 extends OpMode {
...
//    public Intake intake;
    ...
    public void buildPaths(){
        ...
        ScorePRELOAD = follower.pathBuilder()
                .addPath(new BezierLine(StartTOP_Blue, shootTop_BLUE))
                .setLinearHeadingInterpolation(StartTOP_Blue.getHeading(), shootTop_BLUE.getHeading())

                .addPath(new BezierLine(shootTop_BLUE, initialTURNtop_Blue))
                .setLinearHeadingInterpolation(shootTop_BLUE.getHeading(), initialTURNtop_Blue.getHeading())
        ...
        ScoreFIRST = follower.pathBuilder()
                .addPath(new BezierLine(initialTURNtop_Blue, turnBackBLUE))
                .setLinearHeadingInterpolation(initialTURNtop_Blue.getHeading(), turnBackBLUE.getHeading())
        ...
        ScoreTHIRD = follower.pathBuilder()
                .addPath(new BezierLine(shootAtBasket_BLUE, groupCPickUp1_BLUE))
                .setLinearHeadingInterpolation(shootAtBasket_BLUE.getHeading(), groupCPickUp1_BLUE.getHeading())
                ...
                .addPath(new BezierLine(groupAPickUp2_BLUE, groupAPickUp1_BLUE))
                .setLinearHeadingInterpolation(groupCPickUp2_BLUE.getHeading(), groupCPickUp1_BLUE.getHeading())

                .addPath(new BezierLine(groupAPickUp2_BLUE, shootAtBasket_BLUE))
                .setLinearHeadingInterpolation(groupCPickUp1_BLUE.getHeading(), shootAtBasket_BLUE.getHeading())
