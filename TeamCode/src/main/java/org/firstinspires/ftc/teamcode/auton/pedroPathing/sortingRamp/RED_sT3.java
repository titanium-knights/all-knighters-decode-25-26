...
@Autonomous(name = "RED_sT3")
public class RED_sT3 extends OpMode {
...
//    public Intake intake;
    ...
    private final Pose StartBottom_Red = new Pose(65.25, 0,Math.toRadians(90));
    ...
    public void buildPaths(){
        ...
        ScorePRELOAD = follower.pathBuilder()
                .addPath(new BezierLine(StartBottom_RED, initialTURN_RED))
                .setLinearHeadingInterpolation(StartBottom_RED.getHeading(), initialTURN_RED.getHeading())

                .addPath(new BezierLine(initialTURN_RED, moveTowardsBasket_RED))
                .setLinearHeadingInterpolation(initialTURN_RED.getHeading(), moveTowardsBasket_RED.getHeading())

                .addPath(new BezierLine(moveTowardsBasket_RED, shootAtBasket_RED))
                .setLinearHeadingInterpolation(moveTowardsBasket_RED.getHeading(), shootAtBasket_RED.getHeading())
