    ...
    public static ThreeWheelConstants localizerConstants =
            new ThreeWheelConstants()
                    ...
                    .forwardTicksToInches(
                            (0.00196607212991782 + 0.0019881096060913117 + 0.0019880031977263964) / 3
                    )
                    .strafeTicksToInches(
                            (0.002009976001604704 + 0.002041508937831714 + 0.002012647092666368) / 3
                    )
                    .turnTicksToInches(
                            (0.001884453071334851 + 0.0018875352236261628 + 0.0018905010619355532) / 3
                    )
            ;
