...
//    public Intake intake;
    ...
    public void buildPaths(){
        ...
        ScoreFIRST = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(StartTOP_Blue.getHeading(), groupAPickUp1_BLUE.getHeading())
        ...
        ScoreSECOND = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(midPoint_Triangle.getHeading(), groupBPickUp2_BLUE.getHeading())
