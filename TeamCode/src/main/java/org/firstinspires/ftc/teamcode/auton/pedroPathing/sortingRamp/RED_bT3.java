...
@Autonomous(name = "RED_bT3")
public class RED_bT3 extends OpMode {
...
//    public Intake intake;
    ...
    private final Pose shootTop_BLUE = new Pose(20, 120, Math.toRadians(320));

    private final Pose initialTURN_BLUE = new Pose(130, 80, Math.toRadians(90));
    private final Pose initialTURNtop_Blue = new Pose(20, 120, Math.toRadians(320));
    private final Pose turnBackBLUE = new Pose(20, 120, Math.toRadians(120));
    private final Pose moveTowardsBasket_BLUE = new Pose(72, 130, Math.toRadians(90));

    private final Pose StartTOP_Red = new Pose(20, 130, Math.toRadians(120));

    private final Pose shootTOP_Red = new Pose(70, 80, Math.toRadians(340));

    private final Pose initialTURNtop_Red = new Pose(50, 60, Math.toRadians(80));

    private final Pose turnBackRED = new Pose(20, 60, Math.toRadians(250));
    ...
    public void buildPaths(){
        ...
        ScorePRELOAD = follower.pathBuilder()
                .addPath(new BezierLine(StartTOP_Red, shootTOP_Red))
                .setLinearHeadingInterpolation(StartTOP_Red.getHeading(), shootTOP_Red.getHeading())

                .addPath(new BezierLine(shootTOP_Red, initialTURNtop_Red))
                .setLinearHeadingInterpolation(shootTOP_Red.getHeading(), initialTURNtop_Red.getHeading())
        ...
        ScoreFIRST = follower.pathBuilder()
                .addPath(new BezierLine(initialTURNtop_Red, turnBackRED))
                .setLinearHeadingInterpolation(initialTURNtop_Red.getHeading(), turnBackRED.getHeading())
        ...
        ScoreSECOND = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(shootAtBasket_RED.getHeading(), groupBPickUp1_BLUE.getHeading())
                ...
                .addPath(new BezierLine(groupBPickUp2_RED, groupBPickUp1_RED))
                .setLinearHeadingInterpolation(groupBPickUp2_RED.getHeading(), groupBPickUp1_RED.getHeading())

                .addPath(new BezierLine(groupBPickUp2_RED, shootAtBasket_RED))
                .setLinearHeadingInterpolation(groupBPickUp1_RED.getHeading(), shootAtBasket_RED.getHeading())
        ...
        ScoreTHIRD = follower.pathBuilder()
                ...
                .addPath(new BezierLine(groupAPickUp2_RED, groupAPickUp1_RED))
                .setLinearHeadingInterpolation(groupCPickUp2_RED.getHeading(), groupCPickUp1_RED.getHeading())
